    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ areActiveRoutes(['regions.index', 'regions.show', 'regions.edit', 'regions.create']) }}">
                ...
                <ul class="treeview-menu">
                     <li class='{{ isActiveURL("/regions/create") }}'>
                    ...
                    @foreach ($regions as $region)
                        <li class='{{ isActiveURL("/regions/$region->id") }}'>
                            <a href="/regions/{{$region->id}}"><i class="fa fa-circle-o"></i>&nbsp;&nbsp; {{$region->name}}</a>
                        </li>
                    @endforeach
                </ul>
            </li>
            ...
            <li class="treeview {{ areActiveRoutes(['types.index', 'types.show', 'types.edit', 'types.create']) }}">
                ...
                <ul class="treeview-menu">
                    <li class='{{ isActiveURL("/types/create") }}'>
                    ...
                    @foreach ($types as $type)
                        <li class='{{ isActiveURL("/types/$type->id") }}'>
                            <a href="/types/{{$type->id}}"><i class="fa fa-circle-o"></i>&nbsp;&nbsp; {{$type->type_name}}</a>
                        </li>
                    @endforeach
                </ul>
            </li>
